// Project55.cpp : This file contains the 'main' function. Program execution begins and ends there.
//In C++ (but not in C), two or more functions in the same scope can have the same name. This is called function overloading.
