// writers-6.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
	...
	const int ile = sizeof(writers) / sizeof(writers[0]); // for size.
	...
	// The manipulator setw has been used here just to better format the printout. The sorting function implements insertion sort algorithm (without sentinel).
	for (int i = 0; i < ile; i++)
